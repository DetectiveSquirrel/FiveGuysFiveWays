...
namespace FiveGuysFiveWays
{
    ...
    public static class Helper
    {
        ...
        private static Camera Camera => FiveGuysFiveWays.Instance.GameController.Game.IngameState.Camera;
        ...
        {
            var windowRect = FiveGuysFiveWays.Instance.GameController.Window.GetWindowRectangle();
